...
export default function StepThree({ handleNext }: any) {
  return (
    <section className="flex flex-col w-full items-center font-Montserrat text-deep_blue font-bold m-auto gap-10 py-3">
      <div className="lg:grid grid-cols-4 grid-rows-3 gap-5 hidden overflow-x-scroll items-center snap-x">
      ...
      <div className="lg:hidden flex text-center flex-col items-center">
        <Image src={phone} alt="blog" />
        <h3>WATCH AND CREATE MOVIES. SERIES AND SHORT FILMS</h3>
      </div>
